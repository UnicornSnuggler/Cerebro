...
namespace Cerebro
{
    public class Constants
    {
        ...
        public static List<string> ITALICS = new List<string>()
        {
            ...
            "(This card is both a Spider-Woman card and an Aggression card.)",
            "(This card is both a Spider-Woman card and a Justice card.)",
            "(This card is both a Spider-Woman card and a Leadership card.)",
            "(This card is both a Spider-Woman card and a Protection card.)",
        ...
        public static Dictionary<string, string> OVERRIDES = new Dictionary<string, string>()
        {
            ...
            { "Madame Hydra", null },
            { "Setup. Attach to the villain.", null },
            { "Team-Up", null },
